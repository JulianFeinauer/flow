...
@Route(value = "com.vaadin.flow.uitest.ui.JavaScriptRetrunValueView", layout = ViewTestLayout.class)
public class JavaScriptRetrunValueView extends AbstractDivView {

    public JavaScriptRetrunValueView() {
